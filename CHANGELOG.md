...
- migrate custom intrinsic event variants
...
- *(test)* stabilize shell evaluator artifact lookup
- *(test)* allow shell evaluator cold starts
- *(test)* extend shell fixture build deadline
...
- sync develop/0.4.0 into typed custom events
