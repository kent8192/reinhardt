...
- *(ci)* add breaking change discussion announcement automation
...
- *(ci)* address Copilot review feedback on breaking change workflow

### Maintenance

- upgrade workspace dependencies to latest versions
- add .wtp.yml to .gitignore
- merge main into fix/issue-3474-expose-introspect-feature
- trigger release announcement only when release PR is merged
- use isolated temp paths and add error handling for tag snapshots
