...
- *(test)* update WASM binary test to check catch-all route pattern

### Maintenance

- merge main into test/issue-3114-to-3116-spec-based-test-coverage
...
- *(admin)* fix router.rs import ordering for cross-platform rustfmt compatibility
