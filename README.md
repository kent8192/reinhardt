...
cargo install reinhardt-admin-cli --version "0.4.0-alpha.11"
...
<!-- reinhardt-version-sync -->
**Current release line:** Reinhardt documentation tracks `0.4.0-alpha.11`. From
...
reinhardt = { version = "0.4.0-alpha.11", package = "reinhardt-web" }
```
...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.11", package = "reinhardt-web", default-features = false, features = ["full"] }
```
...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.11", package = "reinhardt-web", default-features = false, features = ["minimal"] }
```
...
[dependencies]
# Core components
reinhardt-http = "0.4.0-alpha.11"
reinhardt-urls = "0.4.0-alpha.11"

# Optional: Database
reinhardt-db = "0.4.0-alpha.11"
...
reinhardt-graphql = "0.4.0-alpha.11"
reinhardt-websockets = "0.4.0-alpha.11"
```
...
```bash
reinhardt-admin startproject my-api \
  --reinhardt-version "0.4.0-alpha.11" \
