...
cargo install reinhardt-admin-cli --version "0.3.13"
...
<!-- reinhardt-version-sync -->
**Current release line:** Reinhardt documentation tracks `0.3.13`. From
...
reinhardt = { version = "0.3.13", package = "reinhardt-web" }
```
...
```toml
[dependencies]
reinhardt = { version = "0.3.13", package = "reinhardt-web", default-features = false, features = ["full"] }
```
...
```toml
[dependencies]
reinhardt = { version = "0.3.13", package = "reinhardt-web", default-features = false, features = ["minimal"] }
```
...
[dependencies]
# Core components
reinhardt-http = "0.3.13"
reinhardt-urls = "0.3.13"
...
reinhardt-admin = "0.3.13"

# Optional: Advanced features
reinhardt-graphql = "0.3.13"
