...
## [0.4.0-alpha.7](https://github.com/kent8192/reinhardt-web/compare/reinhardt-admin@v0.4.0-alpha.6...reinhardt-admin@v0.4.0-alpha.7) - 2026-08-14
...
- *(admin)* close changelist queryset review findings
- *(admin)* address inline editing review findings

### Maintenance

- auto-fix fmt and clippy
- *(admin)* merge develop/0.4.0 into pr 6002
- *(admin)* merge develop/0.4.0 into pr 6004
