...
use crate::types::{
	...
	InlineFormInfo, InlineRowInfo, InlineStyle, ModelInfo, MutationResponse,
};
...
mod tests {
	use super::{
		...
		detail_view, find_admin_action, form_element_with_description, form_value_to_json,
	...
	use crate::types::{
		...
		InlineEditResponse, ModelPermission, MutationResponse,
	};
