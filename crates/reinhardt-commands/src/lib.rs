...
pub use cli::{
	...
	execute_from_command_line_with_migration_settings_and_shell,
	execute_from_command_line_with_registry,
	execute_from_command_line_with_registry_and_migration_settings,
	execute_from_command_line_with_registry_and_migration_settings_and_shell,
	execute_from_command_line_with_registry_and_settings,
