...
## [0.4.0-alpha.7](https://github.com/kent8192/reinhardt-web/compare/reinhardt-db@v0.4.0-alpha.6...reinhardt-db@v0.4.0-alpha.7) - 2026-08-16
...
- *(db)* coordinate file field persistence lifecycle
- *(db)* add storage-backed image field policies
...
- *(db)* compensate staged uploads on cancellation
- *(db)* preserve storage field policy semantics
- *(db)* normalize image field feature semantics
- *(db)* normalize storage field rename detection
- clarify typed file upload lifecycle docs
- harden typed multipart file lifecycle
- *(db)* keep file commits alive through cancellation
