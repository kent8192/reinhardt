...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.10", features = ["grpc"] }

# Or use a preset:
# reinhardt = { version = "0.4.0-alpha.10", features = ["standard"] }  # Recommended
# reinhardt = { version = "0.4.0-alpha.10", features = ["full"] }      # All features
```
...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.10", package = "reinhardt-web", default-features = false, features = ["minimal", "grpc"] }
```
...
```toml
[dependencies]
reinhardt-grpc = { version = "0.4.0-alpha.10", features = ["di"] }
reinhardt-di = "0.4.0-alpha.10"
```
