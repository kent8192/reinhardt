...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.4", features = ["grpc"] }
...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.4", package = "reinhardt-web", default-features = false, features = ["minimal", "grpc"] }
```
