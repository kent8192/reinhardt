...
```toml
[dependencies]
reinhardt = { version = "0.3.12", features = ["grpc"] }
...
```toml
[dependencies]
reinhardt = { version = "0.3.12", package = "reinhardt-web", default-features = false, features = ["minimal", "grpc"] }
```
