...
```toml
[dependencies]
reinhardt = { version = "0.3.11", features = ["grpc"] }
...
```toml
[dependencies]
reinhardt = { version = "0.3.11", package = "reinhardt-web", default-features = false, features = ["minimal", "grpc"] }
```
