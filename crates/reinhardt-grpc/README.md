...
```toml
[dependencies]
reinhardt = { version = "0.3.16", features = ["grpc"] }
...
```toml
[dependencies]
reinhardt = { version = "0.3.16", package = "reinhardt-web", default-features = false, features = ["minimal", "grpc"] }
```
