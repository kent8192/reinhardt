...
```toml
[dependencies]
reinhardt = { version = "0.3.13", features = ["grpc"] }
...
```toml
[dependencies]
reinhardt = { version = "0.3.13", package = "reinhardt-web", default-features = false, features = ["minimal", "grpc"] }
```
