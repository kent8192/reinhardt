...
```toml
[dependencies]
reinhardt = { version = "0.3.10", features = ["grpc"] }
...
```toml
[dependencies]
reinhardt = { version = "0.3.10", package = "reinhardt-web", default-features = false, features = ["minimal", "grpc"] }
```
