...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.11", features = ["grpc"] }

# Or use a preset:
# reinhardt = { version = "0.4.0-alpha.11", features = ["standard"] }  # Recommended
...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.11", package = "reinhardt-web", default-features = false, features = ["minimal", "grpc"] }
```
...
```toml
[dependencies]
reinhardt-grpc = { version = "0.4.0-alpha.11", features = ["di"] }
reinhardt-di = "0.4.0-alpha.11"
```
