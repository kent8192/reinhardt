...
resource "github_actions_variable" "tf_github_owner" {
  repository    = var.github_repository
  variable_name = "TF_GITHUB_OWNER"
...
resource "github_actions_variable" "tf_github_repository" {
  repository    = var.github_repository
  variable_name = "TF_GITHUB_REPOSITORY"
