...
- `#[field(skip = true)]`, `#[field(skip_getter = true)]`, or
  `#[field(skip_info = true)]` fields: excluded
...
- Use `#[field(skip_getter = true)]` to suppress both a field's accessor and its
  inclusion in the Info struct, or `#[field(skip_info = true)]` to exclude it
  only from Info; `#[user]` automatically excludes its mapped password-hash field
