...
# Match the profile generated by evcxr 0.22.0 so its first evaluation reuses
# the dependencies built by the fixture bootstrap instead of compiling them a second time.
[profile.dev]
opt-level = 2
debug = false
strip = "debuginfo"
